...
from geometry_msgs.msg import VisibilityConstraint
...
#        start_state.joint_state.header.stamp = rospy.Time.now()
        ...
        msg.allowed_planning_time = 10.0
        msg.planner_id = planner
...
def moveit_callback(msg):
    pub = rospy.Publisher('/update_joint_position', Float64MultiArray, queue_size=10)
    stock_pub = rospy.Publisher('/stock_joint_position', Float64MultiArray, queue_size=10)
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/planner/update", String, set_planner_callback)
