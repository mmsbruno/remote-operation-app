...
class CollisionSceneExample(object):
    ...
    def add_four_boxes(self):
        box1_pose = [0.35, 0, 0.42, 0, 0, 0, 1]
        box1_dimensions = [0.01, 1.1, 0.84]

        box2_pose = [0, 0, 0, 0, 0, 0, 1]
        box2_dimensions = [0.7, 1.1, 0.01]

        box3_pose = [0, 0.55, 0.42, 0, 0, 0, 1]
        box3_dimensions = [0.7, 0.01, 0.84]

        box4_pose = [0, -0.55, 0.42, 0, 0, 0, 1]
        box4_dimensions = [0.7, 0.01, 0.84]

        box5_pose = [0, 0, 0.84, 0, 0, 0, 1]
        box5_dimensions = [0.7, 1.1, 0.01]
        ...
        print "========== Added 5 obstacles to the scene!!"
